...
export default function PostEntry({ id, title, coverImage, date }) {
  return (
    <Link href={`/blog/${id}`}>
        <a>
            <div className="relative blog-entry-bg bg-dark-blue-light p-6 flex flex-col justify-between min-h-10 mb-5 md:w-64 md:mr-5 2xl:w-80 transform transition shadow-lg hover:-translate-y-2px hover:scale-102">
