...
export default function ProjectEntry({ title, coverImage, demoUrl, desc }) {
  return (
    <a href={demoUrl} target="_blank" rel="noopener noreferrer">
        <div className="bg-dark-blue-light flex flex-col mb-5 md:min-h-21rem md:w-56 md:mr-5 2xl:w-80 transform transition shadow-lg hover:-translate-y-2px hover:scale-102">
